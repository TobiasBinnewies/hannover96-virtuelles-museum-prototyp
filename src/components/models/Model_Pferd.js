...
export default function Model_Pferd() {
  ...
  return (
    <model-viewer className={'relative mt-20'}
                  alt="Modell H96 Pferd" poster={'/poster_pferd.png'}
                  src='pferd.glb' ios-src='/pferd.usdz' ar ar-modes="webxr scene-viewer quick-look" shadow-intensity='1' camera-controls
