...
function Homepage() {
return (
  <div className={"h-screen sm:bg-[url('/h96-bg-home.png')] bg-no-repeat bg-[url('/h96-bg-home-mobile.png')] p-10"}>
    <div className={"h-[50%] w-[50%] m-auto flex flex-col items-center container"}>
      ...
      <img className={"blur-sm w-[100%] sm:w-[50%] ml-auto mr-auto mt-8"} src={"/H96_Header_Logo.png"}/>
